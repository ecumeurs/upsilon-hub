...
- **Tile Types:** Normal (dark gunmetal), Obstacle (rusty/blocked with texture), Move-Highlighted (cyan glow), Attack-Highlighted (magenta glow).
- **Character Placement:** CharacterPawn components rendered at entity grid positions.
