...
while (!gameOver) {
    try {
        // The turn state is now handled solely by the board.updated event below.
        // We log it and wait for the event.
        ...
        if (isMyTurn) {
            ...
            // Wait for next event to detect end of game
        } else {
        ...
        // Fallback poll
        upsilon.log("Retrying wait after interruption...");
        upsilon.sleep(1000);
    }
}
